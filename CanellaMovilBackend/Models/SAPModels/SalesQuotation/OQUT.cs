...
{
    /// <summary>
    /// Encabezado de una Oferta de Ventas (OQUT)
    /// </summary>
    public class OQUT
    {
        /* CAMPOS NATIVOS SAP  */
        ...
        /// <summary>
        /// ShipToCode - Dirección de Entrega
        /// </summary>
        [Required(ErrorMessage = "La Dirección de entrega no es válida.")]
        ...
        /// </summary>
        [Required]
        public List<QUT1>? Items { get; set; }
